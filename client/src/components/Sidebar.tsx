  ...
  return (
    ...
    >
      ...
      <div className="bg-surface-light rounded-lg p-3 mb-6">
        ...
        <div className="text-sm mb-2 text-foreground">Premium Audio Tools</div>
        <p className="text-xs text-muted-foreground">
          Enhance your music experience with our premium tools.
        </p>
        <Button
          variant="outline"
          className="mt-2 text-xs bg-accent text-accent-foreground px-3 py-1 rounded-full"
        >
          Learn More
        </Button>
      </div>
      ...
      <div className="mt-auto">
        <div className="p-4 bg-gradient-to-r from-primary/20 to-accent/20 rounded-lg">
          ...
          <p className="text-xs text-muted-foreground mb-3">
            Download unlimited tracks, ad-free experience.
          </p>
          <Button className="bg-primary hover:bg-primary/90 text-primary-foreground text-xs font-medium py-1 px-3 rounded-full transition-all">
            Upgrade Now
          </Button>
        </div>
      </div>
