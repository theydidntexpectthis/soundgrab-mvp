  ...
  return (
    <div className="bg-surface rounded-xl p-6 shadow-lg">
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        <Button variant="outline" size="sm" className="px-3 py-1 rounded-full text-xs bg-surface-light hover:bg-primary/20 text-text-secondary transition-all">
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        <Button 
          ...
          onClick={() => {
            ...
            const randomQuery = feelingLuckyQueries[Math.floor(Math.random() * feelingLuckyQueries.length)];
