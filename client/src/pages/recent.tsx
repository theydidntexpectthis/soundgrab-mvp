    ...
    <>
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl md:text-3xl font-heading font-bold">Recent Searches</h1>
        ...
        {isLoading ? (
          ...
          <Card className="bg-surface p-6 text-center">
            ...
            <p className="text-text-secondary mb-4">
              You haven't searched for any songs yet. Start by searching for your favorite music.
            </p>
            <Link href="/search">
              <Button className="bg-primary hover:bg-primary/90 text-white">
                Search Now
          ...
          <div className="grid grid-cols-1 gap-4">
            {searchHistory.map((item) => (
              <Card key={item.id} className="bg-surface hover:bg-surface/90 transition-duration-200">
                <CardContent className="p-4">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-4">
