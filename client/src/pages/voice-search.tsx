    ...
    <div className="container mx-auto p-4">
        ...
        <div className="lg:col-span-1">
          ...
          <div className="mt-6 p-4 bg-surface rounded-lg">
            ...
            <p className="text-text-secondary text-sm mb-3">
              Our voice recognition technology allows you to search for songs by speaking
              the title, artist name, or even lyrics. Simply click the button and start speaking.
            </p>
          ...
          {searchQuery ? (
            ...
            <div className="flex flex-col items-center justify-center h-72 bg-surface rounded-lg">
              <div className="text-text-secondary text-center p-6">
                <h3 className="text-xl font-medium mb-2">Use your voice to find music</h3>
                <p className="max-w-md">
                  Click the "Start Voice Search" button and speak naturally to search for your favorite songs.
                  You can search by artist, title, or even lyrics you remember.
                </p>
              </div>
            </div>
          )}
      ...
      <div className="mt-8 bg-surface-light rounded-lg p-4 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-text-secondary">Upgrade for crystal-clear audio and higher bitrates.</p>
        </div>
